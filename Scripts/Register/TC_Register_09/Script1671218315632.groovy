...
Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (3)'), 'roma123', 0)
...
Mobile.verifyElementText(findTestObject('Register/RegisterInvalid/android.view.View (5)'), '')
