...
Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (4)'), 'testing', 0)
...
Mobile.verifyElementText(findTestObject('Register/RegisterInvalid/android.view.View (4)'), '')
