...
Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (4)'), 'testing  123', 0)

Mobile.tap(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText - confirmation password'), 0)

Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (5)'), 'testing  123', 0)
...
Mobile.verifyElementText(findTestObject('Register/RegisterInvalid/android.view.View (3)'), '')
