...
Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (4)'), 'manusia123', 0)
...
Mobile.verifyElementText(findTestObject('LoginInvalid/android.view.View (2)'), '')
