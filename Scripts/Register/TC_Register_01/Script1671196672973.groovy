...
Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText'), 'Manises', 0)

Mobile.tap(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText - last name'), 0)

Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (1)'), 'Donari', 0)

Mobile.tap(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText - phone number'), 0)

Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (2)'), '081230639876', 0)

Mobile.tap(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText - new email address'), 0)

Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (3)'), 'domari123@gmail.com', 
    0)

Mobile.tap(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText - new password'), 0)

Mobile.setText(findTestObject('Object Repository/Register/RegisterValid/android.widget.EditText (4)'), 'testing123', 0)
...
Mobile.verifyElementText(findTestObject('Object Repository/Register/RegisterValid/android.view.View (1)'), '')
